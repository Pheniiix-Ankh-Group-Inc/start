function HeroSection() {
  return (
    <section className="hero ">
      ...
      <div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">Build Smarter, Scale Faster — with Expert Tech Consulting for Startups and Small Businesses</h1>
