function Footer() {
  ...
  <div className="flex space-x-4 justify-center">
    <a
      ...
      className="btn btn-circle btn-outline text-gray-600 hover:text-pink-500"
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="btn btn-circle btn-outline text-gray-600 hover:text-blue-700"
      aria-label="LinkedIn"
    >
      <svg
        className="w-5 h-5 fill-current"
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="btn btn-circle btn-outline text-gray-600 hover:text-blue-600"
      aria-label="Facebook"
    >
      <svg
        className="w-5 h-5 fill-current"
      ...
      <footer className="bg-base-200 text-base-content border-base-300 border-t px-10 py-4 flex justify-center">
